...
function Set-TargetResource
{
    ...
    if ($LogPath -and $FilePath)
    {
        ...
        {
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg0 -Value "-d$($FilePath)\master.mdf"
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg1 -Value "-e$($LogPath)\ERRORLOG"
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg2 -Value "-l$($LogPath)\mastlog.ldf"
        }
        elseif ([System.IO.Directory]::Exists("C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\"))
        {
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg0 -Value "-d$($FilePath)\master.mdf"
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg1 -Value "-e$($LogPath)\ERRORLOG"
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg2 -Value "-l$($LogPath)\mastlog.ldf"
        }
        elseif ([System.IO.Directory]::Exists("C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\")) 
        {
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg0 -Value "-d$($FilePath)\master.mdf"
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg1 -Value "-e$($LogPath)\ERRORLOG"
            Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQLServer\Parameters" -Name SQLArg2 -Value "-l$($LogPath)\mastlog.ldf"
        }else 
        {
